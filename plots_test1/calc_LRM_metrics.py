...
def calc_LRM_metrics(**model_data):
    ...
    savez(WD+C_dict['model_data']['modn']+'_'+str(TR_sst)+'_dats', model_data=C_dict['model_data'], rawdata_dict = rawdata_dict3)
    ...
    savez(WD+C_dict['model_data']['modn']+'_'+str(TR_sst)+'K_'+ 'ud'+str(TR_sub)+'_dats', model_data=C_dict['model_data'], rawdata_dict = rawdata_dict4)