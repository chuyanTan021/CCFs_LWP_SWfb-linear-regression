...
, nanmean(Rsut_pi[:, latsi1:latsi0 +1,:]))
    ...
    savez(WD+C_dict['model_data']['modn']+'__r2r1_warmcold(Jan)_(largestpiR2)_June7th_23_Anomalies_Rtest'+str(round(TR_sst, 2))+'_dats', model_data = C_dict['model_data'], rawdata_dict = rawdata_dict3)
