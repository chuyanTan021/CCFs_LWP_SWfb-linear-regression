...
def fitLRMobs_1(dict_training, dict_predict, s_range, y_range, x_range, lats, lons, add_IMERG = False):
    ...
    if add_IMERG == False:
        ...
        datavar_obs = ['SST', 'p_e_IMERG', 'LTS', 'SUB', 'LWP', 'LWP_statistic_error', 'rsdt', 'rsut', 'rsutcs', 'albedo', 'albedo_cs', 'alpha_cre']
    ...
    if add_IMERG == False:
        ...
        training_LRM_result, ind_True, ind_False, coef_array_1r, shape_fla_training = rdlrm_1_training(metric_training, predictant='LWP', predictor = ['SST', 'p_e_IMERG', 'LTS', 'SUB'], r = 1)
    ...
    if add_IMERG == False:
        ...
        predict_LRM_result, ind_True_predi, ind_False_predi, shape_fla_predicting = rdlrm_1_predict(metric_predict, coef_array_1r, predictant = 'LWP', predictor = ['SST', 'p_e_IMERG', 'LTS', 'SUB'], r = 1)
