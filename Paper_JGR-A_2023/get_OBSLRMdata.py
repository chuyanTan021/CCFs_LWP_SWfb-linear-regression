...
def get_OBSLRM(valid_range1=[2002, 7, 15], valid_range2=[2016, 12, 31]):
    ...
    # P_IMERG3, lat_imerg, lonm_imerg, times_imerg = read_var_obs_IMERG3(valid_range1=valid_range1, valid_range2=valid_range2, data_type='2')
    ...
    rsutcs = read_var_obs_CERES(varnm = 'toa_sw_clr_t_mon', valid_range1=valid_range1, valid_range2=valid_range2)[0]
