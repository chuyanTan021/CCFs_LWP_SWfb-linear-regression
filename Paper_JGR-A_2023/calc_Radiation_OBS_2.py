...
def pLot_sca_sensitivity_to_albedo_cs_obs1(data_dict, coef_dict, threshold_list, c_albedo_cs= 0.115):
    ...
    path6 = '/glade/scratch/chuyan/Plots/CMIP_R_lwp_4/'
...
def pLot_sca_sensitivity_to_albedo_cs_obs2(data_dict, coef_dict, coef_dict_bin, threshold_list, c_albedo_cs= 0.115):
    ...
    color_list = ["black", "blue", "tab:blue", "tab:orange", "tab:green", "tab:red", "tab:purple", "tab:brown", "tab:olive", "tab:cyan"]
    ...
    plt.savefig(path6 + "pD+bin OBS:_"+"albedo_LWP(95per)_coloredby_albedo_csle0.30.jpg", bbox_inches ='tight', dpi = 250)
