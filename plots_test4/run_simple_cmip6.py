...
def main():
    ...
    #..Dec20 .. added model: E3SM10, CAMSCSM1, INM_CM48, FGOALSg3, MPIESM12LR, NORESM2LM, (ACCESSCM2), (GFDLCM4), (HADGEM3)
    
    #..deck  = [BCCESM1, CanESM5, CESM2, CESM2FV2, CESM2WACCM, CNRMESM2, GISSE21G, GISSE21H, IPSLCM6ALR, MRIESM20, MIROC6, SAM0]   #..current # 12   add..HADGEM3, UKESM10(both them don't have 'wap' in 'pi-C' exp, and need to solve 'day number' issue in cftime.Datetime360Day object of time dimension)
    deck = [E3SM10, CAMSCSM1, INM_CM48, FGOALSg3, MPIESM12LR, NORESM2LM, ACCESSCM2, GFDLCM4, HADGEM3]  # 9
