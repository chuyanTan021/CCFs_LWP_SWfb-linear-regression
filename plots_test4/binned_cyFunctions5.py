...
def binned_cySouthOCEAN(S, lat, lon, r):
    '''
    Calculated the binned array for any defined resolution('r'_degree X 'r'_degree) In Southern Ocean Region
    '''
...
#..for calculating the pcolor map: use two variables to distinguish LWP amount: skin Temperature(SST, as XX)& moisture amount(PRW/WVP or p-e/MC, as YY),
#.. both XX, YY are 2-D arrays.
