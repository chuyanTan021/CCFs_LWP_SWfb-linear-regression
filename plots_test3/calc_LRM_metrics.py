...
def calc_LRM_metrics(THRESHOLD_sst, **model_data):
    # get variable data
    ...
    C_dict =  {'dict0_PI_var':dict1_PI_var, 'dict0_abr_var':dict1_abr_var, 'model_data':model_data}    #..revised in Dec.30th, at 2021
    D_dict  = C_dict.copy()
    B_dict  = C_dict.copy()
    ...
    def fitLRM(C_dict, TR_sst, s_range, y_range, x_range):
        ...
        print("2lrm: regrssed value:", YB_abr, " in 'abr'")
    ...
    def p4plot1(s_range, y_range, x_range, shape_yr_pi, shape_yr_abr, rawdata_dict):
        ...
        print("aremeaned regressed value in 'p4plot1' fun : ", nanmean(areamean_dict_predi['LWP_area_yr_abr']), ' kg m-2')
        ...
        # genarate some array that convenient for plotting
    ...
    savez(WD+C_dict['model_data']['modn']+'_best(test)fit_'+str(TR_sst)+'_dats', model_data=C_dict['model_data'], rawdata_dict = rawdata_dict3)
    ...
    savez(WD+C_dict['model_data']['modn']+'_best(test)fit_'+str(TR_sst)+'K_'+ 'ud'+str(TR_sub)+'_dats', model_data=C_dict['model_data'], rawdata_dict = rawdata_dict4)